...
export default function AdminDashboardPage() {
  ...
  const stats = useMemo(() => {
    ...
    return { total, active, claimed, totalBidValue, highestBid, cities, totalBids: bids.length, capturedPayments: captured.length, pendingPayments: pending.length, failedPayments: failed.length, awaitingPayments: awaiting.length, capturedAmount, pendingApplications, fullApplications, bidOnlyApplications, staleApplications };
