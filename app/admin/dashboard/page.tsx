      ...
      <div className="adminShell">
        ...
        <div className="mainArea">
          ...
          <main className="content">
            ...
            {activeNav === "restaurants" && <section className="panel fullPanel"><PanelHeader title="Restaurant Management" subtitle="All restaurants currently listed on DineUp." search={search} setSearch={setSearch} placeholder="Search restaurant..."/><RestaurantTable restaurants={filteredRestaurants} actionLoading={actionLoading} onToggleActive={(r) => updateRestaurant(r.id, "is_active", r.is_active === false)} onToggleClaim={(r) => updateRestaurant(r.id, "is_claimed", !r.is_claimed)}/></section>}
