...
export default function AccountPage(){
 ...
 return <main className="page">
   ...
   <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",gap:12,margin:"0 0 18px"}}><span style={{fontSize:12,color:"#777"}}>Track your food orders and payment status.</span><Link href="/account/orders" className="action" style={{marginTop:0}}>View orders →</Link><Link href="/account/reservations" className="secondaryAction">View reservations →</Link></div><section className="grid">
