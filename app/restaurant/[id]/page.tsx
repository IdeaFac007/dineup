...
export default function PublicRestaurantProfile(){
 ...
 useEffect(()=>{ async function load(){ if(!Number.isFinite(id)||id<=0){setError("Restaurant not found.");setLoading(false);return;} setTodayKey(new Intl.DateTimeFormat("en-IN",{weekday:"long",timeZone:"Asia/Kolkata"}).format(new Date()).toLowerCase()); try{
