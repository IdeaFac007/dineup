...
const styles=`*{box-sizing:border-box}html,body{margin:0;padding:0}body{font-family:Arial,Helvetica,sans-serif;background:#f4f5f7;color:#171717}button,input,textarea,select{font:inherit}.signupPage{min-height:100vh;height:100vh;overflow:hidden;padding:24px 24px;background:#f4f5f7}.shell{height:100%;max-width:1160px;margin:auto;display:grid;grid-template-columns:minmax(0,1fr) minmax(450px,540px);gap:58px;align-items:center}.brand{display:inline-flex;align-items:center;gap:11px;text-decoration:none;color:#171717}.mark{width:38px;height:38px;border-radius:11px;background:#171717;color:#fff;display:flex;align-items:center;justify-content:center;font-weight:900;font-size:21px}.brand strong{display:block;font-size:20px}.brand small{display:block;margin-top:2px;color:#85898f;font-size:8px;font-weight:800;letter-spacing:1.5px}.hero{margin-top:42px;max-width:500px}.eyebrow{display:block;color:#85898f;font-size:9px;font-weight:900;letter-spacing:1.8px}.hero h1{margin:9px 0 11px;font-size:44px;line-height:1.02;letter-spacing:-2px}.hero h1 em{font-family:Georgia,serif;font-weight:400;color:#d86118}.hero>p{margin:0;color:#70747a;font-size:13px;line-height:1.55}.benefits{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-top:17px}.benefit{padding:9px 10px;border:1px solid #e5e6e8;background:rgba(255,255,255,.58);border-radius:11px}.benefit>span{width:21px;height:21px;border-radius:7px;background:#171717;color:#fff;display:flex;align-items:center;justify-content:center;font-size:10px;font-weight:900;margin-bottom:8px}.benefit strong,.benefit small{display:block}.benefit strong{font-size:9px}.benefit small{color:#85898f;font-size:8px;line-height:1.3;margin-top:2px}.steps{margin-top:17px;display:grid;grid-template-columns:repeat(3,1fr);gap:10px}.requiredBadge{display:inline-block;margin-top:8px;padding:5px 8px;border-radius:999px;background:#fff1e7;color:#d45d17;font-size:8px;font-weight:900;letter-spacing:1px}.step{display:flex;align-items:center;gap:8px}.num{width:26px;height:26px;border-radius:9px;background:#e6e7e9;color:#777b80;display:flex;align-items:center;justify-content:center;font-size:10px;font-weight:900}.num.active{background:#171717;color:#fff}.step strong,.step small{display:block}.step strong{font-size:9px}.step small{margin-top:2px;color:#96999e;font-size:8px}.card{background:#fff;border:1px solid #e4e5e8;border-radius:18px;padding:23px 25px;box-shadow:0 20px 60px rgba(0,0,0,.07)}.header{margin-bottom:16px}.header h2{margin:7px 0 4px;font-size:22px}.header p{margin:0;color:#92959a;font-size:11px}.message{border-radius:10px;padding:12px 13px;margin-bottom:16px;font-size:10px}.message strong,.message span{display:block}.message span{margin-top:4px;line-height:1.5}.error{background:#fff0f0;border:1px solid #f0cccc;color:#9b3030}.success{background:#eaf8f0;border:1px solid #ccebd9;color:#247b4d}.field{margin-bottom:9px}.field label{display:block;margin-bottom:5px;color:#5f6369;font-size:9px;font-weight:800;text-transform:uppercase;letter-spacing:.65px}.field input,.field textarea,.field select{width:100%;border:1px solid #dfe1e4;border-radius:8px;background:#fff;color:#171717;padding:8px 10px;outline:none;font-size:11px}.field textarea{resize:none;line-height:1.4}.field input:focus,.field textarea:focus,.field select:focus{border-color:#777}.cols{display:grid;grid-template-columns:1fr 1fr;gap:10px}.note{display:flex;gap:9px;background:#f6f7f8;border:1px solid #e8e9eb;border-radius:9px;padding:9px;margin:3px 0 10px}.note>span{width:22px;height:22px;border-radius:8px;background:#171717;color:#fff;display:flex;align-items:center;justify-content:center;font-size:10px;font-weight:900;flex-shrink:0}.note strong{font-size:10px}.note p{margin:3px 0 0;color:#85898f;font-size:8px;line-height:1.35}.securityRow{display:grid;grid-template-columns:minmax(0,1fr) 170px;gap:9px;align-items:center}.captchaBox{min-width:0;overflow:hidden}.submit{width:100%;height:40px;border:0;border-radius:9px;background:#171717;color:#fff;padding:10px 8px;font-size:10px;font-weight:800;cursor:pointer}.submit:disabled{opacity:.55}.login{text-align:center;margin-top:10px;color:#8b8e94;font-size:10px}.login a{color:#171717;font-weight:800;text-decoration:none}@media(max-width:900px){.signupPage{height:auto;min-height:100vh;overflow:auto;padding:24px 18px}.shell{height:auto;grid-template-columns:1fr;max-width:650px;gap:30px}.hero{margin-top:30px}}@media(max-width:600px){.signupPage{padding:20px 14px}.hero h1{font-size:35px;letter-spacing:-1.4px}.benefits{grid-template-columns:1fr}.steps{grid-template-columns:1fr}.card{padding:22px 18px}.cols{grid-template-columns:1fr}.securityRow{grid-template-columns:1fr}.submit{height:42px}}`;