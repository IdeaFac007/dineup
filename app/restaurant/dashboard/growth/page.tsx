...
export default function RestaurantGrowthPage() {
  ...
  if (error || !restaurant) return <main className="page"><style jsx>{styles}</style><div className="shell"><section className="panel"><div className="eyebrow">GROWTH CENTER</div><h1>Unable to load</h1><p className="muted">{error}</p><Link href="/restaurant/dashboard" className="primary">Back to dashboard →</Link></section></div></main>;
