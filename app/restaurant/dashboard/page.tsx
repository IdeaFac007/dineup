...
const styles = `
  * { box-sizing: border-box; }
  ...
  .stats { display:grid; grid-template-columns:repeat(6,minmax(0,1fr)); gap:12px; margin-bottom:20px; }.stat,.panel { background:#fff; border:1px solid #e5e5e5; border-radius:16px; }.stat { padding:18px; min-height:120px; }.stat span,.stat small { display:block; color:#777; font-size:11px; }.stat strong { display:block; font-size:28px; margin:9px 0 5px; letter-spacing:-1px; }.panel { padding:22px; margin-bottom:20px; }.grid { display:grid; grid-template-columns:1fr 1fr; gap:20px; }.panelTitle { display:flex; justify-content:space-between; align-items:flex-start; gap:12px; margin-bottom:18px; }.panelTitle b { font-size:16px; }.rankBox { display:grid; grid-template-columns:1fr 45px 1fr; align-items:center; padding:18px; border-radius:14px; background:#f7f7f7; margin-bottom:14px; }.rankBox small { display:block; color:#777; font-size:11px; }.rankBox strong { display:block; font-size:30px; margin-top:4px; }.arrow { text-align:center; font-size:25px; }.row { display:flex; justify-content:space-between; padding:12px 0; border-bottom:1px solid #eee; font-size:13px; }.notice { background:#f7f7f7; border-radius:12px; padding:13px; margin-top:14px; font-size:13px; }.notice p { margin:5px 0 0; color:#666; }.summary { display:grid; gap:16px; }.summary small { display:block; color:#777; font-size:10px; text-transform:uppercase; letter-spacing:.6px; margin-bottom:4px; }.summary b { font-size:14px; }.summary p { margin:4px 0 0; color:#777; font-size:12px; }.analyticsPanel { margin-top:0; }.liveData { background:#111; color:#fff; }.analyticsGrid { display:grid; grid-template-columns:repeat(6,minmax(0,1fr)); gap:12px; }.analyticsItem { padding:16px; border:1px solid #e8e8e8; border-radius:14px; background:#fafafa; }.analyticsItem span { display:block; color:#777; font-size:11px; }.analyticsItem strong { display:block; font-size:24px; margin-top:7px; }
