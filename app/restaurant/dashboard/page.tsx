...
export default function RestaurantDashboard() {
  ...
  async function uploadProfileImage(kind: "logo" | "cover", file: File) {
    ...
    try {
      ...
      const path = `${restaurant.id}/${kind}-${Date.now()}.${safeExtension}  @media(max-width:760px){.nextStepBanner{align-items:flex-start;flex-direction:column}.nextStepBanner .primary{width:100%}}
`;
