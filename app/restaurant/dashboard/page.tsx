...
export default function RestaurantDashboard() {
  ...
  return <main className="page"><style jsx>{styles}</style>
    <header className="nav"><Link href="/" className="brand">Dine<span>Up</span></Link><div className="navRight"><span className="pill">Restaurant Partner</span><Link href="/restaurant/dashboard/reservations" className="secondary">Reservations</Link><Link href="/restaurant/dashboard/orders" className="text">Orders</Link><Link href="/restaurant/dashboard/reviews" className="text">Reviews</Link><Link href="/marketplace" className="text">Marketplace</Link><button type="button" className="secondary" onClick={handleLogout} disabled={loggingOut}>{loggingOut ? "Logging out..." : "Logout"}</button></div></header>
    <div className="shell">
