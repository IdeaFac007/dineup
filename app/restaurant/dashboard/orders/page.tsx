        ...
        (payload) => {
          ...
          const eventLabel = payload.eventType === "INSERT"
            ...
            : payload.eventType === "UPDATE"
              ? "Order updated."
              : "Order removed.";
          setMessage(changedOrder.order_number ? `${eventLabel} ${changedOrder.order_number}` : eventLabel);
        ...
        <div className="heading">
          <div>
            ...
            <div className="titleRow">
              <h1>Orders</h1>
              <span className="live"><i /> Live updates</span>
            </div>
