...
export default function MarketplacePage(){
  ...
  return <main className="market">
    ...
    <section className="hero"><div className="heroInner">
      ...
      <div className="trust"><span>✓ Verified restaurants</span><span>•</span><span>Live marketplace</span><span>•</span><span>Direct contact</span><span>•</span><span>Search by cuisine</span></div>
    </div></section>
